function Frame48() {
  return (
    <div
      className="content-stretch flex flex-col gap-[34px] items-start relative shrink-0 w-full max-w-[734px]"
      data-name="Frame"
    >
      <div className="[word-break:break-word] font-['Neucha:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[16px] text-black tracking-[2.5px] uppercase w-[min-content] whitespace-pre-wrap">
        ...
        <p className="font-['Montserrat:Medium',sans-serif] font-medium leading-[1.5] normal-case text-[16px] text-white tracking-[1.5px]">
          Join the businesses helping provide safe shelter, daily care and a
          better future for rescue dogs in Bulgaria.
        </p>
      </div>
      <div
        className="bg-[#cb383e] relative rounded-[7px] shrink-0 transition-all duration-200 cursor-pointer hover:brightness-95 hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0"
        data-name="Button"
      >
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-center px-[40px] py-[15px] relative size-full">
            <p className="[word-break:break-word] font-['Neucha:Regular',sans-serif] leading-[34px] not-italic relative shrink-0 text-[22px] text-white tracking-[2px] uppercase whitespace-nowrap">
  ...
  return (
    ...
    >
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#1fd661] text-[18px] text-center whitespace-nowrap">
        <p className="leading-[normal]">Spotify</p>
      </div>
    </div>
  )
}
  ...
  return (
    ...
    >
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#e31221] text-[18px] text-center whitespace-nowrap">
        <p className="leading-[normal]">Netflix</p>
      </div>
    </div>
  )
}
  ...
  return (
    ...
    >
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0061ff] text-[18px] text-center whitespace-nowrap">
        <p className="leading-[normal]">Dropbox</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="relative shrink-0 w-full max-w-[576px] pt-[14px]">
      ...
      <div className="-translate-x-1/2 absolute bg-[#5a8b5c] content-stretch flex items-center justify-center left-1/2 px-[12px] top-0">
        <p className="[word-break:break-word] font-['Neucha:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#d6e4d5] text-[20px] text-center tracking-[1.5px] whitespace-nowrap">
...
export default function CorporateCrossPromo() {
  return (
    <div
      className="bg-[#5a8b5c] content-stretch flex flex-col lg:flex-row gap-12 lg:gap-[60px] items-center justify-center overflow-clip px-6 md:px-16 lg:px-[120px] py-16 md:py-20 relative shrink-0 w-full"
      data-name="Corporate cross-promo"
    >
      <Frame48 />
      <PartnerPanel />
    </div>
